...
# DFLAGS += -DUSE_ESSL_FFT -DUSE_MPI -DSCALAPACK -DADD_ -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D$(PLT)
 DFLAGS += -DUSE_ESSL_FFT -DUSE_MPI -DSCALAPACK -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D$(PLT)
