...
# ESSLDIR = /usr/local/tools/essl/5.1
 ESSLDIR = $(LIBHOME)/bgq_essl/031312_beta
...
CC=$(BGQ_SDK_PATH)/comm/xl/bin/mpixlc_r
 ...
 DFLAGS += -DPRINTALL -DUSE_FFTW -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64
...
# LIBS =  $(SCALAPACKLIB) -lfftw -lblas -llapack -lm
 LIBPATH = -L$(FFTWDIR) -L$(LAPACKDIR) -L$(BLASDIR) -L/opt/ibmcmp/xlsmp/bg/3.1/bglib64 -L/opt/ibmcmp/xlf/bg/14.1/bglib64
 LIBS =  $(SCALAPACKLIB) -lfftw -lblas -llapack -lxlf90_r -lxlsmp -lxlfmath $(HPMLIBS)
