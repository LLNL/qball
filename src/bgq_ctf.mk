...
# SCALAPACK_DIR = $(LIBHOME)/scalapack-2.0/scalapack-bgq-xlc-jaggemm
 ...
 CTFDIR = $(LIBHOME)/ctf-pgemm-copy/cyclopstf/
...
# DFLAGS += -DPRINTALL -DUSE_CTF -DUSE_JAGGEMM -DUSE_FFTW -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -DTAU
 DFLAGS += -DPRINTALL -DUSE_CTF -DUSE_SCALAPACK -DUSE_FFTW -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -DTAU
...
# LIBS =  $(CTFLIB) $(SCALAPACKLIB) $(JAGGEMMLIB) -lfftw -lesslsmpbg -lblas -llapack -lxlf90_r -lxlsmp -lxlfmath
 LIBS =  $(CTFLIB) $(SCALAPACKLIB) -lfftw -lesslsmpbg -lblas -llapack -lxlf90_r -lxlsmp -lxlfmath
