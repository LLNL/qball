...
CC=$(BGQ_SDK_PATH)/comm/xl/bin/mpixlc_r
 ...
 DFLAGS += -DPRINTALL -DUSE_JAGGEMM -DUSE_FFTW -DUSE_CSTDIO_LFS -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -DHPM -DXML -DUSE_XERCES
 
 INCLUDE = -I$(FFTWDIR) -I$(ESSLDIR)/include -I$(XERCESCDIR)/include
 ...
 LIBPATH = -L$(FFTWDIR) -L$(LAPACKDIR) -L$(BLASDIR) -L$(ESSLDIR)/lib -L/opt/ibmcmp/xlsmp/bg/3.1/bglib64 -L/opt/ibmcmp/xlf/bg/14.1/bglib64 -L$(XERCESCLIBDIR)
# LIBS =  $(SCALAPACKLIB) -lfftw -lesslsmpbg -lblas -llapack -lxlf90_r -lxlsmp -lxlfmath $(HPMLIBS)
 LIBS =  $(SCALAPACKLIB) $(JAGGEMMLIB) -lfftw -lesslsmpbg -lblas -llapack -lxlf90_r -lxlsmp -lxlfmath -lxerces-c $(HPMLIBS)
