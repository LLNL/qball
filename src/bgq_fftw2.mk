...
# OMPHACK = 1
 ...
 FFTW2DIR = $(LIBHOME)/fftw/fftw-bgq/fftw-2.1.3/fftw
 FFTWLIB=$(FFTW2DIR)/libfftw.a
 ...
 DFLAGS += -DPRINTALL -DUSE_FFTW2 -DUSE_JAGGEMM -DUSE_CSTDIO_LFS \
	-D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -DHPM -DUSE_XERCES -DXERCESC_3
 
 INCLUDE = -I$(FFTW2DIR) -I$(ESSLDIR)/include -I$(XERCESCDIR)
 
 CXXFLAGS= -g -O3 -qsmp=omp -qarch=qp -DUSE_MPI -DSCALAPACK -D$(PLT) $(INCLUDE) $(DFLAGS)
 CFLAGS= -qsmp=omp -qhot=novector -qsimd=auto -g -O3 -DUSE_MPI -DSCALAPACK -D$(PLT) $(INCLUDE) $(DFLAGS)
