...
//
////////////////////////////////////////////////////////////////////////////////
// $Id: PBESolFunctional.C,v 1.2 2009/11/30 22:38:01 draeger1 Exp $
...
PBESolFunctional::PBESolFunctional(const vector<vector<double> > &rhoe) {
  _nspin = rhoe.size();
...
////////////////////////////////////////////////////////////////////////////////
// 
//  excpbe: PBEsol exchange-correlation 
//  PBE exchange-correlation with modified parameters designed to 
//  more accurately recover the gradient expansion for solids and surfaces.
//
//  PBEsol has been shown to get more accurate results than PBE for solids and surfaces,
//  and less accurate results for isolated atoms and molecules (see ref [c]).
// 
//  input:
//    rho:  density
//    grad: abs(grad(rho))
...
//  [c] J.P. Perdew, A. Ruzsinszky, et al., PRL 100, 136406 (2008)
// 
////////////////////////////////////////////////////////////////////////////////
           
void PBESolFunctional::excpbe(double rho, double grad, double *exc, double *vxc1, double *vxc2) {
...
void PBESolFunctional::excpbe_sp(double rho_up, double rho_dn, 
...
void PBESolFunctional::gcor2(double a, double a1, double b1, double b2, double b3,
