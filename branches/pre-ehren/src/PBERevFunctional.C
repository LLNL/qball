...
//
////////////////////////////////////////////////////////////////////////////////
// $Id: PBERevFunctional.C,v 1.1 2009/11/30 22:38:01 draeger1 Exp $
...
PBERevFunctional::PBERevFunctional(const vector<vector<double> > &rhoe) {
  _nspin = rhoe.size();
...
////////////////////////////////////////////////////////////////////////////////
// 
//  excpbe: PBErev exchange-correlation 
...
//
//  PBErev has been shown to get more accurate results than PBE for atoms and molecules
//  (see ref [c]).
// 
//  input:
//    rho:  density
...
//  [c] Y.Zhang and W.Yang, Phys. Rev. Lett. 80, 890 (1998).
// 
////////////////////////////////////////////////////////////////////////////////
           
void PBERevFunctional::excpbe(double rho, double grad, double *exc, double *vxc1, double *vxc2) {
...
void PBERevFunctional::excpbe_sp(double rho_up, double rho_dn, 
...
void PBERevFunctional::gcor2(double a, double a1, double b1, double b2, double b3,
